                                ...
                                <div class="row gy-4">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select col-md-6 mb-2" name="priority" id="priority" required>
                                            ...
                                            <option value="Pagi"<?php echo e($complaint->KETERANGAN_SHIFT == "Pagi" ? 'selected' : ''); ?>>Pagi</option>
                                            <option value="Siang"<?php echo e($complaint->KETERANGAN_SHIFT == "Siang" ? 'selected' : ''); ?>>Siang</option>
                                            <option value="Malam"<?php echo e($complaint->KETERANGAN_SHIFT == "Malam" ? 'selected' : ''); ?>>Malam</option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select col-md-6 mb-2" name="nama_petugas" id="nama_petugas" required>
                                            ...
                                            <option value="Jonathan" <?php echo e($complaint->NAMA_PETUGAS == "Jonathan" ? 'selected' : ''); ?>>Jonathan</option>
                                            <option value="Gailea" <?php echo e($complaint->NAMA_PETUGAS == "Gailea" ? 'selected' : ''); ?>>Gailea</option>
                                            <option value="Nathan" <?php echo e($complaint->NAMA_PETUGAS == "Nathan" ? 'selected' : ''); ?>>Nathan</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 mb-2">
                                        ...
                                        <textarea name="identitas" id="identitas" cols="30" rows="5" class="form-control" required><?php echo e($complaint->IDENTITAS); ?></textarea>
                                    </div>


                                    <div class="form-group col-md-12 mb-2">
                                        <label for="desc">Kondisi IGD</label>
                                        <textarea name="desc" id="desc" cols="30" rows="5" class="form-control" required><?php echo e($complaint->KONDISI_IGD); ?></textarea>
                                    </div>
                                    <div class="form-group col-md-12 mb-2">
...
<?php $__env->startPush('after-script'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/tes.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.landing.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Backupan\Sahabat_pelanggan\resources\views/complaint/admin/edit_complaint.blade.php ENDPATH**/ ?>