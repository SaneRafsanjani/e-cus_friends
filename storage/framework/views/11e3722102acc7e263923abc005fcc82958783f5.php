                        ...
                        <div class="row">
                            <div class="table-rensponsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>tes</th>
                                        <td><?php echo e(strtotime($complaint->WAKTU_SELESAI) - strtotime($complaint->WAKTU_MULAI)); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="" id="form_upload_foto">
                    <div class="modal-body">
                        <input type="file" name="file_selesai" id="file_selesai" class="form-control">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ipsrs\resources\views/complaint/admin/show.blade.php ENDPATH**/ ?>