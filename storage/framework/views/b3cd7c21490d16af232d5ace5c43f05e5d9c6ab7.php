            ...
            <div class="container">
                <div class="row">
                    <header class="section-header" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                        <p>Form Pengaduan Kerusakan IPSRS</p>
                    </header>
                            ...
                            <div class="php-email-form mt-3" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select col-md-6 mb-2" name="priority" id="priority">
...
<?php echo $__env->make('layouts.landing.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ipsrs\resources\views/complaint/user/create.blade.php ENDPATH**/ ?>