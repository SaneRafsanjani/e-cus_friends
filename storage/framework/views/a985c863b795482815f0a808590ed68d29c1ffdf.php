        ...
        <div class="col-12">
			<div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                <div class="card-header">
                    <div class="btn-group">
                        <a href="<?php echo e(route('admin.complaint.ev.download', $id)); ?>" target="_blank" class="btn btn-outline-primary"><i class="fa fa-download"></i> Download Bukti</a>
                        <a href="<?php echo e(route('admin.complaint.print', $id)); ?>" class="btn btn-outline-primary" target="_blank"><i class="fa fa-print"></i> Print</a>
                        <?php if($complaint->STATUS == 1): ?>
                        <button class="btn btn-outline-primary" type="button" id="proceed_complaint" data-id="<?php echo e($id); ?>" data-status="2"><i class="fa fa-check"></i> Proses</button>
                        <?php else: ?>
                            <?php if($news): ?>
                            <a href="<?php echo e(route('admin.complaint.ne.download', $id)); ?>" class="btn btn-outline-primary" target="_blank"><i class="fa fa-download"></i> Download Berita Acara</a>
                            <?php else: ?>
                            <a href="<?php echo e(route('admin.complaint.news', $id)); ?>" class="btn btn-outline-primary"><i class="fa fa-pencil"></i> Buat Berita Acara</a>
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\wbs\resources\views/complaint/admin/show.blade.php ENDPATH**/ ?>