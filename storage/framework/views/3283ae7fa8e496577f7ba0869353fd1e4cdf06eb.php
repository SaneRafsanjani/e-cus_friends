        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mt-5 text-center" id="search_result">
                    <div id="search_complaint_loading"></div>
                </div>
                <div class="col-lg-12 mt-5 text-center" id="search_result">
...
<?php echo $__env->make('layouts.landing.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Backupan\Sahabat_pelanggan\resources\views/complaint/user/show.blade.php ENDPATH**/ ?>