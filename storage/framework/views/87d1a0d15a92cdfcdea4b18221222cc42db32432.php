                                    ...
                                    <div class="form-group col-md-6 mb-2 mt-4">
                                        ...
                                        <select class="form-control" name="pelaksana" id="pelaksana">
                                            ...
                                            <?php $__currentLoopData = $petugas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($p->NAMA_PETUGAS); ?>"><?php echo e($p->NAMA_PETUGAS); ?></option>
...
<?php echo $__env->make('layouts.landing.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ipsrs\resources\views/complaint/admin/petugas.blade.php ENDPATH**/ ?>