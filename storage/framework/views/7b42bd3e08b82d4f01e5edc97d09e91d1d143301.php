                            ...
                            <div class="php-email-form mt-3" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                ...
                                <div class="row gy-4">
                                    <div class="form-group col-md-12 mb-2 mt-4">
                                        ...
                                        <input class="form-control" id="reported_name" type="date" name="reported_name" required>
...
<?php echo $__env->make('layouts.landing.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Pengaduan\esimrs\resources\views/complaint/user/create.blade.php ENDPATH**/ ?>