                ...
                <div class="nav-right col-8 pull-right right-header p-0">
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown p-0 me-0 float-right">
                            ...
                            <img class="b-r-10" src="https://ui-avatars.com/api/?name=<?php echo e(auth()->user()->name); ?>" alt="" style="width: 35px">
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.complaint.inbox')); ?>"> <i data-feather="home"></i></a></li>
...
<?php /**PATH C:\Users\SIMRS02\Documents\esimrs\resources\views/layouts/admin/master.blade.php ENDPATH**/ ?>