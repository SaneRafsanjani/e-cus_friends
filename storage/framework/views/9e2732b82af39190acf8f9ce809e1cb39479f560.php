<table>
    <tr>
        <th>Tahun</th>
        <th><?php echo e($year_start); ?> - <?php echo e($year_end); ?></th>
    </tr>
</table>
<table>
    ...
    <tbody>
        <?php $__currentLoopData = $report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><?php echo e($r->YEAR_COMPLAINT); ?></td>
...
<?php /**PATH D:\xampp\htdocs\wbs\resources\views/complaint/admin/export/annual-excel.blade.php ENDPATH**/ ?>