                    ...
                    <form action="" method="post" id="add_complaint">
                        <div class="php-email-form mt-3" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="200">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="g-recaptcha" data-sitekey="<?php echo e(config('services.gcaptcha.key')); ?>"></div>
                            </div>
...
<?php echo $__env->make('layouts.landing.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wbs\resources\views/complaint/user/create.blade.php ENDPATH**/ ?>