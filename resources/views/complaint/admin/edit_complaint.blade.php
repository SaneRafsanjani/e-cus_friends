                            ...
                            <div class="php-email-form mt-3" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                ...
                                <div class="row gy-4">
                                    <div class="form-group col-md-12 mb-2 mt-4">
                                        ...
                                        <input class="form-control" id="reported_name" type="date" name="reported_name" required max="{{ date('Y-m-d') }}">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select col-md-6 mb-2" name="priority" id="priority" required>
                                            ...
                                            <option value="Pagi"{{ $complaint->KETERANGAN_SHIFT == "Pagi" ? 'selected' : '' }}>Pagi</option>
                                            <option value="Siang"{{ $complaint->KETERANGAN_SHIFT == "Siang" ? 'selected' : '' }}>Siang</option>
                                            <option value="Malam"{{ $complaint->KETERANGAN_SHIFT == "Malam" ? 'selected' : '' }}>Malam</option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select col-md-6 mb-2" name="nama_petugas" id="nama_petugas" required>
                                            ...
                                            <option value="Jonathan" {{ $complaint->NAMA_PETUGAS == "Jonathan" ? 'selected' : '' }}>Jonathan</option>
                                            <option value="Gailea" {{ $complaint->NAMA_PETUGAS == "Gailea" ? 'selected' : '' }}>Gailea</option>
                                            <option value="Nathan" {{ $complaint->NAMA_PETUGAS == "Nathan" ? 'selected' : '' }}>Nathan</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 mb-2">
                                        ...
                                        <textarea name="identitas" id="identitas" cols="30" rows="5" class="form-control" required>{{ $complaint->IDENTITAS }}</textarea>
                                    </div>


                                    <div class="form-group col-md-12 mb-2">
                                        <label for="desc">Kondisi IGD</label>
                                        <textarea name="desc" id="desc" cols="30" rows="5" class="form-control" required>{{ $complaint->KONDISI_IGD }}</textarea>
                                    </div>
                                    <div class="form-group col-md-12 mb-2">
