                ...
                <div class="nav-right col-8 pull-right right-header p-0">
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown p-0 me-0 float-right">
                            ...
                            <img class="b-r-10" src="https://ui-avatars.com/api/?name={{ auth()->user()->name }}" alt="" style="width: 35px">
                ...
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.complaint.inbox') }}"> <i data-feather="home"></i></a></li>
                ...
                <div class="container-fluid">
                      <div class="row">
                            <div class="col-md-12 footer-copyright text-center">
                                  <p class="mb-0">Copyright {{ date('Y') }} © RSUD Kota Bogor</p>
                            </div>
                      </div>
                </div>
          </footer>
